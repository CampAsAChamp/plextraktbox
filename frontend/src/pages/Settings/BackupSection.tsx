    ...
    >
      <Stack gap="md">
        ...
        <Text size="sm" c="dimmed">
          Download a consistent SQLite snapshot, or restore from a previous download. Restoring
          replaces the live database and reloads the app. On TrueNAS, prefer ZFS snapshots of the{" "}
      ...
      >
        <Stack gap="md">
          <Text size="sm">
            ...
            ? This cannot be undone from the UI. A copy of the current database is kept as{" "}
            <code>plextraktbox.db.pre-restore</code> on disk.
          </Text>
