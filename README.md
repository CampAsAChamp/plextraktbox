...
dataset, single HTTP port). Personal install is [Phase 16](docs/phases/phase-16.md); App Catalog
publication is [Phase 17](docs/phases/phase-17.md).
...
Built incrementally — **Phase 7** (real movie fetch) is next, then **Phase 8** (apply); Phases 0–6 are done.
