...
Examples: `feat: add mobile nav drawer`, `fix: retry Trakt token refresh on 401`,
`chore: tighten API health badge typography`

**Releases:** Commits that land on `main` (direct push or squash-merge PR title) must be
Conventional Commits. CI also checks PR titles via `.github/workflows/pr-title.yml`.
