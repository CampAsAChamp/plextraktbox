...
**Releases (Phase 19):** When squash-merging a PR to `main` that should trigger a version bump, use a Conventional Commit **PR title** (`feat:`, `fix:`, `feat!:`). release-please parses that squash commit; local branch commits stay plain.
