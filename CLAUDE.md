...
See [docs/phases/README.md](docs/phases/README.md). Phases 0–8, **11 (TV sync)**, **12 (CI)**, **13 (settings/ops)**, **14 (dashboard UX)**, and **18 (version/build info)** are done; next is mobile layout (20) or automated releases (19), then Doppler (15), sync fetch/resolve caches (21), TrueNAS deploy (22–23), and **UI themes (24)** last. Frontend redesign (former 9–10) was retired — stay on Mantine.
