...
**Status:** Not wired up yet — personal install is [Phase 11](../phases/phase-11.md); catalog
publication is [Phase 12](../phases/phase-12.md).
...
## Milestone 1 — Personal install (Phase 11)
...
**Near-term deliverables** (see [phase-11](../phases/phase-11.md)):
...
## Milestone 2 — App Catalog (Phase 12)

Getting **plextraktbox** **listed in the TrueNAS App Catalog** is a separate, heavier effort. Do
**not** start until Phase 11 has run successfully on real hardware for a while.

**Catalog deliverables** (see [phase-12](../phases/phase-12.md)):
...
## Quick reference (Phase 11 install shape)

When Phase 11 lands, expect roughly:
...
Detailed install steps will be added here as Phase 11 is implemented.
