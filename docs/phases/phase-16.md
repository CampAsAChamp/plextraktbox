# Phase 16 — TrueNAS App Catalog publication
...
**Do not start until Phase 15 has been running
...
- App behaves identically to Phase 15 manual install

## Prerequisites

[Phase 15](phase-15.md) — personal install stable on real hardware
